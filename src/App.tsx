...
const PRODUCTS_DATA = [
  ...
  // --- NUEVOS PRODUCTOS INTEGRADOS ---
  { id: 8, name: "Cuccio - Lavender & Chamomile", description: "Mantequilla hidratante no grasa, ideal para relajar y calmar la piel.", ingredients: "Extracto de lavanda, manzanilla.", image: "/images/Gemini_Generated_Image_m04kcm04kcm04kcm.png", bgColor: "#E8EBD8", accent: "#7D8B5E", category: "Calmante" },
  { id: 9, name: "Cuccio - Milk & Honey", description: "Fórmula hidratante intensiva que retiene la humedad para revelar un brillo natural y saludable.", ingredients: "Miel, leche, extractos botánicos.", image: "/images/Gemini_Generated_Image_u6yezeu6yezeu6ye.png", bgColor: "#EDE6DA", accent: "#C9A96E", category: "Hidratante" },
  { id: 10, name: "Cuccio - Pomegranate & Fig", description: "Mantequilla rica en antioxidantes con efecto anti-edad y revitalizante para la piel del cuerpo.", ingredients: "Granada, higo.", image: "/images/Gemini_Generated_Image_wj19btwj19btwj19.png", bgColor: "#E8EBD8", accent: "#7A5E8B", category: "Rejuvenecedor" },
  { id: 11, name: "Cuccio - White Truffle Souffle", description: "Body butter souffle de lujo con textura ultra ligera para una hidratación profunda y rica.", ingredients: "Trufa blanca, antioxidantes naturales.", image: "/images/Gemini_Generated_Image_fwf1z1fwf1z1fwf1.png", bgColor: "#F5F5F5", accent: "#8A8276", category: "Hidratante" },
  { id: 12, name: "Cuccio - Vanilla Bean & Sugar", description: "Mantequilla corporal con un aroma reconfortante que acondiciona y suaviza intensamente la piel.", ingredients: "Vainilla, caña de azúcar.", image: "/images/Gemini_Generated_Image_26i1jb26i1jb26i1.png", bgColor: "#EDE6DA", accent: "#9B7B4A", category: "Hidratante" },
  { id: 13, name: "Cuccio - Sweet Almond", description: "Fórmula hidratante rica en nutrientes para restaurar y mantener la suavidad natural de la piel.", ingredients: "Almendra dulce, vitamina E.", image: "/images/Gemini_Generated_Image_a1bfe4a1bfe4a1bf.png", bgColor: "#F3EFE6", accent: "#A67B5B", category: "Hidratante" },
  { id: 14, name: "Cuccio - Citrus & Wild Berry", description: "Mantequilla revitalizante con un refrescante toque cítrico y de frutos del bosque para despertar la piel.", ingredients: "Cítricos, bayas silvestres.", image: "/images/Gemini_Generated_Image_8w5t3g8w5t3g8w5t.png", bgColor: "#DDE8D8", accent: "#4A7A5E", category: "Revitalizante" },
  { id: 15, name: "Cuccio - Whipped Hemp", description: "Mantequilla revitalizante batida para una absorción superior y nutrición profunda.", ingredients: "Aceite de semilla de cáñamo, Cupuaçu, Chía.", image: "/images/Gemini_Generated_Image_xfuj49xfuj49xfuj.png", bgColor: "#E5ECD9", accent: "#5C7844", category: "Revitalizante" },
];
